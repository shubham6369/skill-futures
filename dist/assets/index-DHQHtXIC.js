 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Op{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(Lp(t)){const r=t.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(t=>t).join(" ")}}function Lp(n){const e=n.getComponent();return(e==null?void 0:e.type)==="VERSION"}const Wi="@firebase/app",Ac="0.14.10";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Hi="[DEFAULT]",lm={[Wi]:"fire-core",[xp]:"fire-core-compat",[Fp]:"fire-analytics",[Mp]:"fire-analytics-compat",[$p]:"fire-app-check",[Up]:"fire-app-check-compat",[Bp]:"fire-auth",[qp]:"fire-auth-compat",[jp]:"fire-rtdb",[zp]:"fire-data-connect",[Wp]:"fire-rtdb-compat",[Hp]:"fire-fn",[Gp]:"fire-fn-compat",[Kp]:"fire-iid",[Qp]:"fire-iid-compat",[Yp]:"fire-fcm",[Jp]:"fire-fcm-compat",[Xp]:"fire-perf",[Zp]:"fire-perf-compat",[em]:"fire-rc",[tm]:"fire-rc-compat",[nm]:"fire-gcs",[rm]:"fire-gcs-compat",[sm]:"fire-fst",[om]:"fire-fst-compat",[im]:"fire-vertex","fire-js":"fire-js",[am]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xu(n,e=[]){let t;switch(n){case"Browser":t=Oc(Ie());break;case"Worker":t=`${Oc(Ie())}-${n}`;break;default:t=n}const r=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${Cn}/${r}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ls={async loadJS(){throw new Error("Unable to load external scripts")},recaptchaV2Script:"",recaptchaEnterpriseScript:"",gapiScript:""};function Xm(n){Ls=n}function Mu(n){return Ls.loadJS(n)}function Zm(){return Ls.recaptchaEnterpriseScript}function eg(){return Ls.gapiScript}function tg(n){return`__${n}${Math.floor(Math.random()*1e6)}`}class ng{constructor(){this.enterprise=new rg}ready(e){e()}execute(e,t){return Promise.resolve("token")}render(e,t){return""}}class rg{ready(e){e()}execute(e,t){return Promise.resolve("token")}render(e,t){return""}}const sg="recaptcha-enterprise",Fu="NO_RECAPTCHA";class ig{constructor(e){this.type=sg,this.auth=sn(e)}async verify(e="verify",t=!1){async function r(i){if(!t){if(i.tenantId==null&&i._agentRecaptchaConfig!=null)return i._agentRecaptchaConfig.siteKey;if(i.tenantId!=null&&i._tenantRecaptchaConfigs[i.tenantId]!==void 0)return i._tenantRecaptchaConfigs[i.tenantId].siteKey}return new Promise(async(a,l)=>{xm(i,{clientType:"CLIENT_TYPE_WEB",version:"RECAPTCHA_ENTERPRISE"}).then(u=>{if(u.recaptchaKey===void 0)l(new Error("recaptcha Enterprise site key undefined"));else{const d=new Lm(u);return i.tenantId==null?i._agentRecaptchaConfig=d:i._tenantRecaptchaConfigs[i.tenantId]=d,a(d.siteKey)}}).catch(u=>{l(u)})})}function s(i,a,l){const u=window.grecaptcha;kc(u)?u.enterprise.ready(()=>{u.enterprise.execute(i,{action:e}).then(d=>{a(d)}).catch(()=>{a(Fu)})}):l(Error("No reCAPTCHA enterprise script loaded."))}return this.auth.settings.appVerificationDisabledForTesting?new ng().execute("siteKey",{action:"verify"}):new Promise((i,a)=>{r(this.auth).then(l=>{if(!t&&kc(window.grecaptcha))s(l,i,a);else{if(typeof window>"u"){a(new Error("RecaptchaVerifier is only supported in browser"));return}let u=Zm();u.length!==0&&(u+=l),Mu(u).then(()=>{s(l,i,a)}).catch(d=>{a(d)})}}).catch(l=>{a(l)})})}}async function xc(n,e,t,r=!1,s=!1){const i=new ig(n);let a;if(s)a=Fu;else try{a=await i.verify(t)}catch{a=await i.verify(t,!0)}const l={...e};if(t==="mfaSmsEnrollment"||t==="mfaSmsSignIn"){if("phoneEnrollmentInfo"in l){const u=l.phoneEnrollmentInfo.phoneNumber,d=l.phoneEnrollmentInfo.recaptchaToken;Object.assign(l,{phoneEnrollmentInfo:{phoneNumber:u,recaptchaToken:d,captchaResponse:a,clientType:"CLIENT_TYPE_WEB",recaptchaVersion:"RECAPTCHA_ENTERPRISE"}})}else if("phoneSignInInfo"in l){const u=l.phoneSignInInfo.recaptchaToken;Object.assign(l,{phoneSignInInfo:{recaptchaToken:u,captchaResponse:a,clientType:"CLIENT_TYPE_WEB",recaptchaVersion:"RECAPTCHA_ENTERPRISE"}})}return l}return r?Object.assign(l,{captchaResp:a}):Object.assign(l,{captchaResponse:a}),Object.assign(l,{clientType:"CLIENT_TYPE_WEB"}),Object.assign(l,{recaptchaVersion:"RECAPTCHA_ENTERPRISE"}),l}async function Yi(n,e,t,r,s){var i;if((i=n._getRecaptchaConfig())!=null&&i.isProviderEnabled("EMAIL_PASSWORD_PROVIDER")){const a=await xc(n,e,t,t==="getOobCode");return r(n,a)}else return r(n,e).catch(async a=>{if(a.code==="auth/missing-recaptcha-token"){console.log(`${t} is protected by reCAPTCHA Enterprise for this project. Automatically triggering the reCAPTCHA flow and restarting the flow.`);const l=await xc(n,e,t,t==="getOobCode");return r(n,l)}else return Promise.reject(a)})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ku(){return typeof Ge().WorkerGlobalScope<"u"&&typeof Ge().importScripts=="function"}async function Og(){if(!(navigator!=null&&navigator.serviceWorker))return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function Lg(){var n;return((n=navigator==null?void 0:navigator.serviceWorker)==null?void 0:n.controller)||null}function xg(){return Ku()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ky=new Z(x.comparator);function lt(){return ky}const Ch=new Z(x.comparator);function rr(...n){let e=Ch;for(const t of n)e=e.insert(t.key,t);return e}function kh(n){let e=Ch;return n.forEach(((t,r)=>e=e.insert(t,r.overlayedDocument))),e}function zt(){return lr()}function Vh(){return lr()}function lr(){return new on((n=>n.toString()),((n,e)=>n.isEqual(e)))}const Vy=new Z(x.comparator),Dy=new le(x.comparator);function z(...n){let e=Dy;for(const t of n)e=e.add(t);return e}const Ny=new le(j);function Oy(){return Ny}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zs{constructor(){this._=void 0}}function Ly(n,e,t){return n instanceof bs?(function(s,i){const a={fields:{[ph]:{stringValue:fh},[gh]:{timestampValue:{seconds:s.seconds,nanos:s.nanoseconds}}}};return i&&Co(i)&&(i=Bs(i)),i&&(a.fields[mh]=i),{mapValue:a}})(t,e):n instanceof Er?Lh(n,e):n instanceof vr?xh(n,e):(function(s,i){const a=Oh(s,i),l=fl(a)+fl(s.Ae);return to(a)&&to(s.Ae)?Dh(l):Oo(s.serializer,l)})(n,e)}function xy(n,e,t){return n instanceof Er?Lh(n,e):n instanceof vr?xh(n,e):t}function Oh(n,e){return n instanceof Ir?(function(r){return to(r)||(function(i){return!!i&&"doubleValue"in i})(r)})(e)?e:{integerValue:0}:null}class bs extends zs{}class Er extends zs{constructor(e){super(),this.elements=e}}function Lh(n,e){const t=Mh(e);for(const r of n.elements)t.some((s=>Ze(s,r)))||t.push(r);return{arrayValue:{values:t}}}class vr extends zs{constructor(e){super(),this.elements=e}}function xh(n,e){let t=Mh(e);for(const r of n.elements)t=t.filter((s=>!Ze(s,r)));return{arrayValue:{values:t}}}class Ir extends zs{constructor(e,t){super(),this.serializer=e,this.Ae=t}}function fl(n){return ne(n.integerValue||n.doubleValue)}function Mh(n){return ko(n)&&n.arrayValue.values?n.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fo{constructor(){this.kr=new le(he.qr),this.Kr=new le(he.Ur)}isEmpty(){return this.kr.isEmpty()}addReference(e,t){const r=new he(e,t);this.kr=this.kr.add(r),this.Kr=this.Kr.add(r)}$r(e,t){e.forEach((r=>this.addReference(r,t)))}removeReference(e,t){this.Wr(new he(e,t))}Qr(e,t){e.forEach((r=>this.removeReference(r,t)))}Gr(e){const t=new x(new Y([])),r=new he(t,e),s=new he(t,e+1),i=[];return this.Kr.forEachInRange([r,s],(a=>{this.Wr(a),i.push(a.key)})),i}zr(){this.kr.forEach((e=>this.Wr(e)))}Wr(e){this.kr=this.kr.delete(e),this.Kr=this.Kr.delete(e)}jr(e){const t=new x(new Y([])),r=new he(t,e),s=new he(t,e+1);let i=z();return this.Kr.forEachInRange([r,s],(a=>{i=i.add(a.key)})),i}containsKey(e){const t=new he(e,0),r=this.kr.firstAfterOrEqual(t);return r!==null&&e.isEqual(r.key)}}class he{constructor(e,t){this.key=e,this.Jr=t}static qr(e,t){return x.comparator(e.key,t.key)||j(e.Jr,t.Jr)}static Ur(e,t){return j(e.Jr,t.Jr)||x.comparator(e.key,t.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`+n.stack),e}class xn extends Ys{constructor(e,t,r,s){super(e,t,r,s),this.type="firestore",this._queue=new Bl,this._persistenceKey=(s==null?void 0:s.name)||"[DEFAULT]"}async _terminate(){if(this._firestoreClient){const e=this._firestoreClient.terminate();this._queue=new Bl(e),this._firestoreClient=void 0,await e}}}function Wv(n,e){const t=typeof n=="object"?n:_o(),r=typeof n=="string"?n:Is,s=rn(t,"firestore").getImmediate({identifier:r});if(!s._initialized){const i=Qf("firestore");i&&zv(s,...i)}return s}function Jo(n){if(n._terminated)throw new k(R.FAILED_PRECONDITION,"The client has already been terminated.");return n._firestoreClient||Hv(n),n._firestoreClient}function Hv(n){var r,s,i,a;const e=n._freezeSettings(),t=jv(n._databaseId,((r=n._app)==null?void 0:r.options.appId)||"",n._persistenceKey,(s=n._app)==null?void 0:s.options.apiKey,e);n._componentsProvider||(i=e.localCache)!=null&&i._offlineComponentProvider&&((a=e.localCache)!=null&&a._onlineComponentProvider)&&(n._componentsProvider={_offline:e.localCache._offlineComponentProvider,_online:e.localCache._onlineComponentProvider}),n._firestoreClient=new xv(n._authCredentials,n._appCheckCredentials,n._queue,t,n._componentsProvider&&(function(u){const d=u==null?void 0:u._online.build();return{_offline:u==null?void 0:u._offline.build(d),_online:d}})(n._componentsProvider))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ud(n){n=Xe(n,re);const e=Xe(n.firestore,xn),t=Jo(e);return Uv(t,n._key).then((r=>oI(e,n,r)))}function ca(n){n=Xe(n,xt);const e=Xe(n.firestore,xn),t=Jo(e),r=new Nd(e);return nI(n._query),$v(t,n._query).then((s=>new Tn(e,r,n,s)))}function $d(n,e,t){n=Xe(n,re);const r=Xe(n.firestore,xn),s=Fd(n.converter,e),i=Zs(r);return la(r,[Pd(i,"setDoc",n._key,s,n.converter!==null,t).toMutation(n._key,xe.none())])}function Gl(n,e,t,...r){n=Xe(n,re);const s=Xe(n.firestore,xn),i=Zs(s);let a;return a=typeof(e=se(e))=="string"||e instanceof Xo?Jv(i,"updateDoc",n._key,e,t,r):Yv(i,"updateDoc",n._key,e),la(s,[a.toMutation(n._key,xe.exists(!0))])}function iI(n,e){const t=Xe(n.firestore,xn),r=Wt(n),s=Fd(n.converter,e),i=Zs(n.firestore);return la(t,[Pd(i,"addDoc",r._key,s,n.converter!==null,{}).toMutation(r._key,xe.exists(!1))]).then((()=>r))}function la(n,e){const t=Jo(n);return Bv(t,e)}function oI(n,e,t){const r=t.docs.get(e._key),s=new Nd(n);return new Gt(n,s,e._key,r,new ir(t.hasPendingWrites,t.fromCache),e.converter)}(function(e,t=!0){$_(Cn),Je(new Fe("firestore",((r,{instanceIdentifier:s,options:i})=>{const a=r.getProvider("app").getImmediate(),l=new xn(new j_(r.getProvider("auth-internal")),new H_(a,r.getProvider("app-check-internal")),uy(a,s),a);return i={useFetchStreams:t,...i},l._setSettings(i),l}),"PUBLIC").setMultipleInstances(!0)),Oe(jl,zl,e),Oe(jl,zl,"esm2020")})();const Bd="@firebase/installations",ua="0.6.21";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
        ...
        <tbody>
          ${O.leaderboard.map((n,e)=>`
            <tr style="border-bottom: 1px solid rgba(255,255,255,0.05);">
              <td style="padding: 1rem;">#${e+1}</td>
              <td style="padding: 1rem; display: flex; align-items: center; gap: 1rem;">
                <div style="width: 35px; height: 35px; background: #2a2a2a; border-radius: 50%;"></div>
                ${n.name}
              </td>
              <td style="padding: 1rem; color: #4ade80; font-weight: 700;">₹ ${n.allTimeEarnings}</td>
            </tr>
          `).join("")}
        </tbody>
      </table>
    ...
    <div class="chart-container">
      <table style="width: 100%; border-collapse: collapse;">
        ...
        <tbody>
          ${O.team.map(n=>`
            <tr style="border-bottom: 1px solid rgba(255,255,255,0.05);">
              <td style="padding: 1rem;">${n.name}</td>
              <td style="padding: 1rem;">${n.email}</td>
              <td style="padding: 1rem;">${new Date(n.joinedAt).toLocaleDateString()}</td>
            </tr>
          `).join("")}
          ${O.team.length===0?'<tr><td colspan="3" style="padding: 2rem; text-align: center; color: var(--text-dim);">No team members yet.</td></tr>':""}
        </tbody>
      </table>
    </div>
  </section>
...
`,it=()=>{var e;const n=document.querySelector("#app");if(O.user)n.innerHTML=`<div class="dashboard-container">${LT()}<div id="main-view" style="flex-grow: 1; overflow-y: auto;">
      ${O.view==="dashboard"?xT():""}
      ${O.view==="courses"?BT():""}
      ...
      `:""}
      ${["upgrade","reports","training","webinars","offers","earning-target","create-account"].includes(O.view)?`
        <section class="main-content">
